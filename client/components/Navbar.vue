  ...
  <div>
    <header class="nav-opt-sprite nav-locate-us nav-lang-en nav-ssl nav-unrec">
      <div class="container-fluid dekstop-nav">
        ...
        <div class="row">
          <!-- Delivery -->
          <div class="col-xs-2 col-lg-2 col-md-2 col-sm-2 pl-2">
            <div class="nav-global-location">
              <nuxt-link to="/adresse" class="nav-a nav-a-2">
                <div class="nav-sprite" id="nav-packard-glow-loc-icon"></div>
                <div id="glow-ingress-block">
                  <span class="nav-line-1" id="plow-ingress-line1"
                    >Deliver to
                  </span>
                  <span class="nav-line-2" id="plow-ingress-line2"
                    >California
                  </span>
                </div>
              </nuxt-link>
          ...
          <!-- Shoping -->
          <div class="col-xs-6 col-lg-5 col-md-4 col-sm-6 p-0">
            <div class="nav-fill">
              <div class="nav-shop">
                <nuxt-link
                  to="/history"
              ...
              <div class="nav-xshop-container">
                <div class="nav-xshop">
                  ...
                  <a href="#" class="nav-a">Gitt cards</a>
          ...
          <div class="col-xl-4 col-lg-5 col-md-4 col-sm-6 p-0">
            <div class="nav-tools">
              <a
                href="#"
                id="icp-nav-flyout"
