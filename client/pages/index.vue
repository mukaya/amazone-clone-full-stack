  ...
  <main class="listingPage">
    <div class="container-fluid">
      <div class="row">
        ...
        <!-- main content -->
        <div class="col-xl-10 col-lg-9 col-md-8 col-sm-9">
          <FeaturedProduct />
                ...
                <div>
                  <div class="row">
                    ...
                    <div class="col-sm-3 text-center">
                      <a href="#">
                          <ImgResponsive :src="product.photo" />
                      </a>
                    </div>
                    ...
                    <div class="col-sm-9">
                      <div class="a-row a-spacing-small">
                        ...
                        <a href="#" class="a-link-normal">
                          <h2 class="a-size-medium">
                            ...
                            <span class="a-letter-space"></span>
                            <span class="a-size-small a-color-secondery"
                              >Sep 3, 2019</span
                            >
                          </h2>
                        </a>
                      ...
                      <!-- Author's name -->
                      <div class="a-row a-spacing-small">
                        <span class="a-size-small a-color-secondery">by</span>
                        <span class="a-size-small a-color-secondery">
                      ...
                      <div class="row">
                        <div class="col-sm-7">
                          ...
                          <div class="a-row a-spacing-none">
                            ...
                            <span class="a-letter-space"></span>
                            <span
                              class="a-size-base-plus a-color-secondery a-text-strike"
                              >$28.00</span
                            >
                          </div>
...
export default {
  components: { FeaturedProduct,ImgResponsive },
